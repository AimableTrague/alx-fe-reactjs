  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {recipes.map((recipe) => (
          <div key={recipe.id} className="bg-white shadow-lg rounded-lg overflow-hidden cursor-pointer p-4 transition-all delay-200 duration-1000 ease-in-out hover:bg-gradient-to-b hover:from-blue-200 hover:to-slate-400">
